...
const ChatWidget: React.FC<ChatWidgetProps> = ({ onClose }) => {
  ...
  const quickActions = getQuickActions();
    ...
    <div role="dialog" aria-label="FloCat chat" className="
      ...
      overflow-hidden
    ">
        <div className="flex-1 overflow-y-auto space-y-2 mb-4 text-[var(--fg)] dark:text-gray-100 min-h-0 max-h-full" ref={messagesEndRef}>
        ...
        <div className="flex-shrink-0 border-t border-[var(--neutral-300)] dark:border-gray-600 pt-4 pb-2">
          <input
            className="
