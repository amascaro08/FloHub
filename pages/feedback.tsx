...
import Layout from '../components/ui/Layout'; // Import Layout component
        ...
        {feedbackData.length > 0 ? (
          <div>
            <div className="flex justify-between p-4 border rounded mb-4">
              <div>
                <p>Open Bugs: {feedbackData.filter(f => f.feedbackType === 'bug' && f.status === 'open').length}</p>
                <p>Open Feature Requests: {feedbackData.filter(f => f.feedbackType === 'feature' && f.status === 'open').length}</p>
              </div>
            </div>
            <div className="flex flex-col gap-4">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <select
                          ...
                          onChange={(e) => {
                            ...
                            console.log(`Status changed for ${feedback.id} to ${e.target.value}`);
                          }}
              ...
              <section className="border rounded p-4">
                ...
                />
                <button className="p-2 rounded bg-primary-500 hover:bg-primary-600 text-white font-medium transition-colors shadow-sm hover:shadow">Add to Backlog</button>
