...
export default function NotesNewPage() {
  ...
  if ((!notesResponse && !notesError) || (!userSettings && !settingsError && shouldFetch)) {
    return <p>Loading notes...</p>;
  }

  // Show error state if either notes or settings failed to load
  if (notesError || settingsError) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Header */}
      <div className="border-b border-neutral-200 dark:border-neutral-700 p-4 bg-white dark:bg-neutral-900">
        <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">Notes</h1>
